...
✅ Улучшение очереди треков (возможность перемещать песни)✅ Добавление команды /loop для повторного воспроизведения✅ Улучшение интеграции с YouTube API для поиска песен✅ Введение интерфейса управления ботом через веб-панель✅ Оптимизация кода для уменьшения задержек
